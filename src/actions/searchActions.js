...
export const fetchJobs = text => dispatch => {
    axios
    .get(`https://cors-anywhere.herokuapp.com/https://jobs.github.com/positions.json?description=${text}`)
...
export const fetchJob = id => dispatch => {
    axios
    .get(`https://jobs.github.com/positions/04206897-960f-466f-b80f-f2bf88c4f472.json`)
    .then(response => dispatch ({
        type: FETCH_JOB,
        payload: response.data
    })
